...
extern vector<KLinePresenter*> g_pOrderVec;
...
extern "C"
{
	__declspec(dllexport) void __cdecl OnPluginInit(TPluginMgrApi* p)
	{
		...
		//是否需要判空？？？
		bool flag = g_pLanguageApi->SetModule(L"TradeCenter");
		...
		*/
		g_pMainFrm->RegMenuItem(MAKE_MENUORDER(0, 10002, 11), L"TC Indicators", KLinePresenter::OnMenuClick);
	}
