...
void TOrderButton::OnPaint()
{
	...
	SelectObject(memdc.GetHdc(), g_FontData.g_FontNum15);
	DrawText(memdc.GetHdc(),LoadRC::ansi_to_unicode(m_strPrice).c_str(), -1, &rcText, DT_VCENTER | DT_CENTER | DT_SINGLELINE);
	...
	SelectObject(memdc.GetHdc(), g_FontData.g_FontNum19);
	DrawText(memdc.GetHdc(), LoadRC::ansi_to_unicode(m_strAction).c_str(), -1, &rcText, DT_CENTER | DT_VCENTER | DT_SINGLELINE);
	DeleteObject(pen);
	DeleteObject(hbrBk);
