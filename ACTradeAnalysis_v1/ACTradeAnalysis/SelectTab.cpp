...
{
	m_MainPattern.push_back(g_pLanguageApi->LangText(TradingOpportunities));
	m_MainPattern.push_back(g_pLanguageApi->LangText(BigMovement));
	m_MainPattern.push_back(g_pLanguageApi->LangText(ConsecutiveCandles));
	//m_MainPattern.push_back(g_pLanguageApi->LangText(MidTermStrID));
	m_wtext = m_MainPattern;
}
