...
class TPointOrderFrmData : public ISQuoteDataSpi, public TradepiEx
{
public:
    TPointOrderFrmData() {};
...
public:
	...
	bool GetBuyAndSellQuoteDataL2(SQuoteSnapShotL2 &BuyQuoteData, SQuoteSnapShotL2 &SellQuoteData)
	{
		BuyQuoteData = m_BuyQuoteDataL2;
		SellQuoteData = m_SellQuoteDataL2;
		return true;
	}
...
private:
	...
	SQuoteSnapShotL2                                m_SellQuoteDataL2;
	SQuoteSnapShotL2                                m_BuyQuoteDataL2;
};