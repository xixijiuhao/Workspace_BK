...
void CxButton::Create(HWND hParent, TCHAR* name, UINT style, UINT id)
{
	HWND button = CreateWindowEx(0, WC_BUTTON, name, WS_VISIBLE | WS_CHILD | WS_CLIPSIBLINGS|BS_GROUPBOX | WS_CLIPCHILDREN | style,
		0, 0, 0, 0, hParent, (HMENU)(id), GetModuleHandle(NULL), NULL);
	Init(button);
}
void CxButton::SetArrow(bool bArrow)
{
	m_bArrow = bArrow;
	InvalidateRect(m_hWnd, NULL, true);
}
BOOL CxButton::Init(HWND hWnd)
{
