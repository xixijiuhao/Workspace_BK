...
void G_COLOREF::Init()
{
	...
	g_HbrRGB100 = CreateSolidBrush(g_ColorRGB100);
...
void G_UIFONT::Init(LANGID LanguageID)
{
	...
	if (LanguageID == CHT || LanguageID == CHS)
	{
		...
		g_FontNumName = sNum;
		g_FontWordRichedit = CreateFont(-14, 0, 0, 0, 0, FALSE, FALSE, FALSE, GB2312_CHARSET, 0, 0, 0, 0, L"黑体");
		g_FontWord9 = CreateFont(-9, 0, 0, 0, 0, FALSE, FALSE, FALSE, DEFAULT_CHARSET, 0, 0, 0, 0, sWord);
        g_FontWord10 = CreateFont(-10, 0, 0, 0, 0, FALSE, FALSE, FALSE, DEFAULT_CHARSET, 0, 0, 0, 0, sWord);
	...
	else
	{
		g_FontWordName = sWord;
		g_FontNumName = sNum;
		g_FontWordRichedit = CreateFont(-13, 0, 0, 0, 0, FALSE, FALSE, FALSE, DEFAULT_CHARSET, 0, 0, 0, 0, sWord);
