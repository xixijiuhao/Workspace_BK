...
public:
    void SetContractNo(string sCode, char* UserNo, TContractKey & stKey);
	...
	void GetQuoteDataL2(SQuoteSnapShotL2 & buy, SQuoteSnapShotL2 & sell, SImpliedDepthL2& implied);
...
private:
	...
	SContractNoType									m_QuoteContractNo;
	SContract *										m_pQuoteContract;
};