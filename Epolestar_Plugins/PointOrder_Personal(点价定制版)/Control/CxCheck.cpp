...
void CxCheck::Create(HWND hParent, UINT id, TCHAR *pszText, UINT style)
{
...
void CxCheck::OnPaint()
{
	...
	HBRUSH hBkBrush = CreateSolidBrush(/*g_ColorRefData.GetColorBackground()*/g_ColorRefData.g_ColorWhite);
