...
CInPlaceCombo* CInPlaceCombo::m_pInPlaceCombo = nullptr; 
...
int CInPlaceCombo::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
	...
	ResetContent(); 
	for (POSITION Pos_ = m_DropDownList.GetHeadPosition(); Pos_ != nullptr;)
	{
								  ...
								  CString strCurSelecetion /*= ""*/, int iCurSel /*= -1*/)
{
	...
	if (nullptr == m_pInPlaceCombo->m_hWnd) 
	{
