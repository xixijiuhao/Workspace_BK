...
VirtualWnd::VirtualWnd()
{
	...
	m_colorBk = g_ColorRefData.g_ColorBackground;
	Wnd_Width = 0;
	Wnd_Height = 0;
	m_bhoverclose = false;
	m_bhovermini = false;
...
void VirtualWnd::OnPaint()
{
	...
	rc.top = rc.bottom; rc.bottom = rect.bottom;
	...
	rc.left = 0 ; rc.right = Wnd_Width ; rc.top = rect.top;  rc.bottom = rect.top + CAPTION_HEIGHT;
	DrawTextA(memdc.GetHdc(), m_TitleName.c_str(), -1, &rc, DT_VCENTER | DT_CENTER|DT_SINGLELINE);
