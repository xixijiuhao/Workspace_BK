...
public:
	...
	~TStaticButton();
public:
	static TStaticButton* CreateStaticButton(HWND hParent, RECT& rect, const char* ptext = "È·¶¨", int index = 0);
	static void CreateButton(HWND hParent, TStaticButton &btn, const char *pText, int index);
