...
public:
	...
	static void CreateEdit(HWND hParent, TEdit &edit, RECT rect, int style = TEDIT_STRING, DWORD specialstyle = 0);
	static enum{ TEDIT_STRING = 0, TEDIT_FLOAT, TEDIT_INT, TEDIT_SINT, TEDIT_NUMCHAR , TEDIT_IP};
public:
