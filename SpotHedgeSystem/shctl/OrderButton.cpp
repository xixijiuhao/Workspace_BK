...
void COrderButton::UpdateLayout()
{
	...
	wcscpy_s(m_InnerItem[OBD_Buy].wContent[IT_NoOffset], L"买 入");
	wcscpy_s(m_InnerItem[OBD_Buy].wContent[IT_NoPosition], L"买开");
	wcscpy_s(m_InnerItem[OBD_Buy].wContent[IT_HasPosition], L"加多");
	wcscpy_s(m_InnerItem[OBD_Buy].wContent[IT_HasMatchPosition], L"锁仓");
	swprintf_s(m_InnerItem[OBD_Buy].wContent[IT_Offer],L"%s%s", L"买开", L"卖开");
    wcscpy_s(m_InnerItem[OBD_Buy].wContent[IT_ShiftPosition], L"买开卖平");

	wcscpy_s(m_InnerItem[OBD_Sell].wContent[IT_NoOffset], L"卖 出");
	wcscpy_s(m_InnerItem[OBD_Sell].wContent[IT_NoPosition], L"卖开");
	wcscpy_s(m_InnerItem[OBD_Sell].wContent[IT_HasPosition], L"加空");
	wcscpy_s(m_InnerItem[OBD_Sell].wContent[IT_HasMatchPosition], L"锁仓");
	swprintf_s(m_InnerItem[OBD_Sell].wContent[IT_Offer], L"%s%s", L"买平", L"卖平");
    wcscpy_s(m_InnerItem[OBD_Sell].wContent[IT_ShiftPosition], L"卖开买平");

	wcscpy_s(m_InnerItem[OBD_Cover].wContent[IT_NoOffset], L"平 仓");
	wcscpy_s(m_InnerItem[OBD_Cover].wContent[IT_NoPosition], L"平 仓");
	wcscpy_s(m_InnerItem[OBD_Cover].wContent[IT_HasPosition], L"平多");
	wcscpy_s(m_InnerItem[OBD_Cover].wContent[IT_HasMatchPosition], L"平空");
	swprintf_s(m_InnerItem[OBD_Cover].wContent[IT_Offer], L"%s%s", L"买开", L"卖平");
	swprintf_s(m_InnerItem[OBD_Cover].wContent[IT_Offer2], L"%s%s", L"买平", L"卖开");
    wcscpy_s(m_InnerItem[OBD_Cover].wContent[IT_ShiftPosition], L"买平卖开");
    wcscpy_s(m_InnerItem[OBD_Cover].wContent[IT_ShiftPosition2], L"卖平买开");

	wcscpy_s(m_ForeignItem[OBD_BuyF].wContent[IT_NoOffset], L"买 入");
	wcscpy_s(m_ForeignItem[OBD_SellF].wContent[IT_NoOffset], L"卖 出");
	...
	swprintf_s(m_InnerItemP[OBP_CoverS].wContent[IT_Offer], L"%s%s", L"买平", L"卖开");
    wcscpy_s(m_InnerItemP[OBP_CoverS].wContent[IT_ShiftPosition], L"买平卖开");
	...
	swprintf_s(m_InnerItemP[OBP_CoverL].wContent[IT_Offer], L"%s%s", L"买开", L"卖平");
    wcscpy_s(m_InnerItemP[OBP_CoverL].wContent[IT_ShiftPosition], L"卖平买开");
...
void COrderButton::OnClickItemInnerP(int item)
{
	...
	case OBP_CoverS:
		//if (m_PosInfo.nShort <= 0)
		//{
		//	if (MessageBox(m_Hwnd, L"该合约无持仓,是否继续", L"提 示", MB_OKCANCEL) == IDCANCEL)
		//		return;
		//}
		orderInfo.Direct = dBuy;
		orderInfo.Offset = oCover;
...
void COrderButton::UpdateValidBtn(int nID)
{
	m_iValidBtn = nID;
	InvalidateRect(m_Hwnd, NULL, TRUE);
	UpdateWindow(m_Hwnd);
