...
public:
	//AutoReg:是否在创建时自动注册
	TraderSpi(bool AutoReg = true): m_bAutoReg(AutoReg)
	{
...
public:	
	...
	virtual void __cdecl OnCertCodeInfo(const TCertCodeInfo* pCertInfo) {};
	virtual void __cdecl OnWeChatQRCode(const TWeChatQRCode* pCertInfo) {};
	virtual void __cdecl OnFundInTransit(const TFundInTransitData* pFundInTransitData) {};
	virtual void __cdecl OnAccountCashSwap(const TAccountCashSwapData* pAccountCashSwapData) {};
};