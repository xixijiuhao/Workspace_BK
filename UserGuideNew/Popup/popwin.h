...
public:
	...
	void CreatePopWin(IOperator*opr, LPCTSTR classname, HWND parent, DWORD style, vector<wstring>& vString, DWORD exstyle = 0, int nleft = 0, int ntop = 0, UINT ncol = 4, UINT nrow = 3);	//创建弹出窗口
