...
void        TDirect2CharByPosition(TDirect& tdirect, char* sztext, int nsize)
{
	switch (tdirect)
	{
	case dNone: 
		strcpy_s(sztext, nsize, ""); 
		break;
	case	dBuy: 
		strcpy_s(sztext, nsize, "多头"); 
		break; 
	case	dSell: 
		strcpy_s(sztext, nsize, "空头"); 
		break; 
	case	dBoth: 
		strcpy_s(sztext, nsize, "双边"); 
		break; 
	}
}
...
//void		TItemType2Char(ItemType& itemtype, char* sztext, int nsize)
//{
//	switch (itemtype)
//	{
//	case itLoss: strcpy_s(sztext, nsize, _GetCheckModeType(7)); break;// sztext = _GetCheckModeType(7); break;//自动止损
//	case itProfit: strcpy_s(sztext, nsize, _GetCheckModeType(8)); break;//sztext = _GetCheckModeType(8); break;//自动止盈
//	case itFloat: strcpy_s(sztext, nsize, _GetCheckModeType(9)); break;//sztext = _GetCheckModeType(9);	break;//自动浮动
//	case itBreakEven: strcpy_s(sztext, nsize, _GetCheckModeType(10)); break;//sztext = _GetCheckModeType(10); break;//保本
//	}
//}
//void TProfitState2Char(tstate st, char* sztext, int nsize)
//{
//	switch (st)
//	{
//	case dtGeneral: strcpy_s(sztext, nsize, _GetCheckModeType(11)); break;// sztext = _GetCheckModeType(11); break;//未触发
//	case dtTrig: strcpy_s(sztext, nsize, _GetCheckModeType(12)); break;// sztext = _GetCheckModeType(12); break;//已触发
//	case dtSuspend: strcpy_s(sztext, nsize, _GetCheckModeType(13)); break;// sztext = _GetCheckModeType(13); break;	//已挂起
//	case dtInvalid: strcpy_s(sztext, nsize, _GetCheckModeType(14)); break;// sztext = _GetCheckModeType(14); break;	//已失效 
//	}
//}
