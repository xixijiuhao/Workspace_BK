...
//lmx add
int MsgBox(HINSTANCE h,HWND hwnd, LPCTSTR sText, LPCTSTR sTitle, UINT nStyle, COLORREF bkColor = RGB(255, 255, 255), COLORREF txtColor = RGB(0, 0, 0), XMSGBOXPARAMS::CUserDefinedButtonCaptions * btnCaptions = nullptr);
//lmx end
