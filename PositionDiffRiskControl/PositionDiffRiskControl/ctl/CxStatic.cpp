...
void CxStatic::Init(HWND hwnd, const wchar_t *wtext, bool btriangle, HFONT hfont)
{
...
void CxStatic::OnPaint()
{
	...
	SetBkMode(memdc,TRANSPARENT);//设置为透明模式
	
	//DrawText(memdc, L"竖向", -1, &rect, DT_VCENTER | DT_SINGLELINE | DT_CENTER);
